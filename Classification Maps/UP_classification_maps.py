...
# MemoryError这个是内存的问题，还真不是先存的问题，是numpy本身读取数据的问题。
# 207400,11,11,103
...
for index_iter in range(ITER):
    ...
    best_weights_DenseNet_path = 'D:/Tensorflow  Learning/3D-DenseNet-Hyperspectral/models-up-3-32/UP_best_3D_DenseNet_' + str(
        index_iter + 1) + '.hdf5'
    ...
    classification_map(y_re, gt_IN, 24, "D:/Tensorflow  Learning/3D-DenseNet-Hyperspectral/Camps/UP_3_32.png")
