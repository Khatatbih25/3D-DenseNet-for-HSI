...
from Utils import zeroPadding, normalization, doPCA, modelStatsRecord, averageAccuracy, densenet_IN, \
    densenet_IN_no_bottleneck_layer, cnn_3D_IN
...
def model_DenseNet():
    model_dense = densenet_IN_no_bottleneck_layer.ResnetBuilder.build_resnet_8((1, img_rows, img_cols, img_channels),
                                                                               nb_classes)
...
for index_iter in range(ITER):
    ...
    best_weights_DenseNet_path = 'D:/Tensorflow  Learning/3D-DenseNet-Hyperspectral/models-in-no-bottlenck-layer-6-24/Indian_best_3D_DenseNet_' + str(
        index_iter + 1) + '.hdf5'
